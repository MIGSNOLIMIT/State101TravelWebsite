...
export const AUDIT_LOG_ACTION_OPTIONS = [
	...
	{ value: "content.knowledgebase.create", label: "Create Knowledgebase Item" },
	{ value: "content.knowledgebase.update", label: "Update Knowledgebase Item" },
	{ value: "content.knowledgebase.delete", label: "Delete Knowledgebase Item" },
