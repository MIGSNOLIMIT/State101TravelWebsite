        ...
        <div className="rounded-lg border shadow bg-white">
          ...
          <div className="p-4 text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={onDeleteEntry} className="ml-auto px-4 py-2 rounded bg-gray-200 hover:bg-gray-300">🗑️ Delete</button>
            </div>
          </div>
        </div>
                ...
                <li key={f.id} className="flex items-center justify-between border rounded p-3">
                  <div className="flex items-center gap-3">
                    ...
                    {f.fileType?.startsWith("image/") ? (
                      ...
                      <span className="h-12 w-12 flex items-center justify-center bg-gray-100 rounded">📄</span>
                    )}
                    <a href={`/api/application/file/${f.id}/signed`} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Download</a>
                  </div>
                  <button onClick={() => onDeleteFile(f.id)} className="px-3 py-2 rounded bg-gray-200 hover:bg-gray-300">🗑️</button>
                </li>
              ))}
            </ul>
          ) : (
