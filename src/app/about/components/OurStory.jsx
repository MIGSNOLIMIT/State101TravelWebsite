...
const DEFAULT_STORY = `State101 Travel has been a trusted expert in visa consultancy since
...
export default function OurStory({ content }) {
  const paragraphs = String(content || DEFAULT_STORY)
    .split(/\n\s*\n/)
  ...
  return (
    <section className="bg-gray-100 py-16 md:py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Two-column content */}
        <div className="grid gap-8 text-gray-700 leading-relaxed md:grid-cols-2 md:gap-10">
